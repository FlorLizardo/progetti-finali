...
const FavouriteCompany = () => {
	...
	const favourites = useSelector((state) => state.favourite.nomeAzienda); //uso useSelector per 'prendere' lo stato e poi utilizzarlo con dispatch
						...
						{favourites.length > 0 ? (
							favourites.map((fav, index) => (
								...
								>
									...
									>
										<i class="bi bi-x-square-fill fs-3 text-danger" style={styles.deleteFav}></i>
									</a>
								</ListGroup.Item>
							))
						) : (
